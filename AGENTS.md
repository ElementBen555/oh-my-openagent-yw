...
|------|--------|--------|-----------|
| 1. Built-in | `packages/omo-opencode/src/mcp/` | `createBuiltinMcps()` | 3 remote HTTP + 4 local stdio MCPs (`lsp`, `codegraph`, `sequential_thinking`, `github`) + offline health-check probe |

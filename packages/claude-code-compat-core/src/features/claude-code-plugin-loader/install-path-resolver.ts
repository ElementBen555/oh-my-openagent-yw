...
function compareCandidatePriority(a: { name: string }, b: { name: string }): number {
...
export function resolveActualInstallPath(configuredInstallPath: string, pluginKey?: string): string | null {

...
import { CODEGRAPH_NODE_BIN_ENV, type CodegraphNodeSupport, evaluateCodegraphNodeSupport } from "./node-support";
...
export function codegraphCommandRequiresSupportedLocalNode(resolution: CodegraphCommandResolution): boolean {
...
export function resolveCodegraphNodeRuntime(options: ResolveCodegraphNodeSupportOptions = {}): string | null {
...
export function resolveCodegraphNodeSupport(options: ResolveCodegraphNodeSupportOptions = {}): CodegraphNodeSupport {
	const env = options.env ?? process.env;

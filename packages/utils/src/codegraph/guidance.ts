...
export function buildCodegraphInitGuidance(projectPath: string, options: CodegraphInitGuidanceOptions = {}): string {
...
function isCodegraphTool(toolName: unknown): boolean {
	...
	return (
		toolName.startsWith("codegraph.") || toolName.startsWith("codegraph_") || toolName.startsWith("mcp__codegraph__")
	);
}

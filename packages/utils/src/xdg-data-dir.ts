...
export function resolveXdgDataDir(appName: string, options: ResolveXdgDataDirOptions = {}): string {
...
function resolveWritableDirectory(preferredDir: string, fallbackSuffix: string, osProvider: XdgOsProvider): string {
	try {

...
import { closeSync, constants, existsSync, openSync, readFileSync, statSync, unlinkSync, writeSync } from "fs";
import {
	getRegistryLockPath,
	LOCK_RETRY_MS,
	LOCK_STALE_MS,
...
export function withRegistryLockOrWait<T>(onLocked: () => T, onLockUnavailable: () => T): T {

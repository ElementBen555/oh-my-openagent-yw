...
import { type AgentsMdCache, type FindAgentsMdUpInput, findAgentsMdUp } from "@oh-my-opencode/rules-engine";
...
import type { AgentsMdContextOutput, AgentsMdInjectedPathsStorage, AgentsMdTruncator } from "./types";

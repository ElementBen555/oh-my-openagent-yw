...
This project defaults to **Chinese** for user-facing output. See the root [`AGENTS.md`](../../../AGENTS.md) "LANGUAGE" section for the full convention (dialogue, documentation, agent prompts, logs).
...
| `mcp/` | 7 built-in MCPs (3 remote + 4 local stdio) + offline health-check probe | yes |

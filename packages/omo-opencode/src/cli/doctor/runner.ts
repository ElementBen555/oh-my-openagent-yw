...
import type { CheckDefinition, CheckResult, DoctorOptions, DoctorResult, DoctorSummary } from "./framework/types";
				...
				issues: [
					{
						...
						description: "Checks did not complete within 30s. A subprocess may be hanging.",
						severity: "error",
					},
				],
			},

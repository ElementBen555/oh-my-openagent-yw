...
import { type ContinuationState, getContinuationState } from "./continuation-state";
...
function areContinuationHooksIdle(ctx: RunContext, continuationState: ContinuationState): boolean {

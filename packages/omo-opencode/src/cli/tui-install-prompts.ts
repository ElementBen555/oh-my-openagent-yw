...
import type { ClaudeSubscription, DetectedConfig, InstallConfig, InstallPlatform } from "./types";
...
async function resolveCodexAutonomous(hasCodex: boolean, override: boolean | undefined): Promise<boolean | null> {

...
import { acquireLock, generateTaskId, getTaskDir, writeJsonAtomic } from "../../features/claude-tasks/storage";
import { syncTaskTodoUpdate } from "./todo-sync";
import type { TaskObject } from "./types";
import { TaskCreateInputSchema, TaskObjectSchema } from "./types";

export function createTaskCreateTool(config: Partial<OhMyOpenCodeConfig>, ctx?: PluginInput): ToolDefinition {
	return tool({

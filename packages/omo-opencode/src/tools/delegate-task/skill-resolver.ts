...
import { extractSkillTemplate, injectGitMasterConfig } from "../../features/opencode-skill-loader/skill-content";
import { getAllSkills, isDisabledSkillAlias } from "../../features/opencode-skill-loader/skill-discovery";

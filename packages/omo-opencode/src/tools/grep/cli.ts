import { type SpawnedProcess, type SpawnOptions, spawn } from "../../shared/bun-spawn-shim";
import { DEFAULT_RG_THREADS, type GrepBackend, type ResolvedCli, resolveGrepCli } from "../../shared/ripgrep-cli";

...
type PrepareLookAtInputResult = { ok: true; value: PreparedLookAtInput } | { ok: false; error: string };
...
type ReadJsonTextPartResult = { ok: true; value: LookAtTextPart } | { ok: false; error: string };

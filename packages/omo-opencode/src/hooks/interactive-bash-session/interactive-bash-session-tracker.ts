...
async function killAllTrackedSessions(abortSession: AbortSession, state: InteractiveBashSessionState): Promise<void> {
...
export function createInteractiveBashSessionTracker(options: { abortSession: AbortSession }): {

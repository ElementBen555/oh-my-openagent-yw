...
import { CODE_BLOCK_PATTERN, INLINE_CODE_PATTERN, KEYWORD_DETECTORS } from "./constants";
...
export function extractPromptText(parts: Array<{ type: string; text?: string; synthetic?: boolean }>): string {
	return parts

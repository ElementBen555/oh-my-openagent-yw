...
async function readSessionTitle(ctx: ReadyNotificationContext, sessionID: string): Promise<string> {
...
async function readSessionMessages(ctx: ReadyNotificationContext, sessionID: string): Promise<SessionMessage[]> {

...
function normalizeSDKMessage(sessionID: string, value: unknown): StoredMessageMeta | null {
...
export async function readMessagesFromSDK(client: OpencodeClient, sessionID: string): Promise<StoredMessageMeta[]> {
	try {

...
import { CONTINUATION_COOLDOWN_MS, CONTINUATION_PROMPT, DEFAULT_SKIP_AGENTS, HOOK_NAME } from "./constants";
...
export async function injectContinuation(args: {
	...
	const hasRunningBgTasks = backgroundManager
		? backgroundManager
				...
				.some((task: { status: string }) => task.status === "running" || task.status === "pending")
		: false;

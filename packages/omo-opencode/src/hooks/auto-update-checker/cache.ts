...
import { ACCEPTED_PACKAGE_NAMES, CACHE_DIR, getUserConfigDir, PACKAGE_NAME } from "./constants";
...
export function invalidatePackage(packageName?: string, options: InvalidatePackageOptions = {}): boolean {
	try {

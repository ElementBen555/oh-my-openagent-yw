...
export function showMaxIterationsToast(ctx: PluginInput, state: RalphLoopState): void {
...
export function showIterationToast(ctx: PluginInput, state: RalphLoopState): void {
	showToastBestEffort(ctx, {
		title: "Ralph Loop",
...
export function showNoProgressToast(ctx: PluginInput): void {
	showToastBestEffort(ctx, {
		title: "Ralph Loop Stopped",

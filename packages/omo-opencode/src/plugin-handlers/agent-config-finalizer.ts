import { clearRegisteredAgentNames, registerAgentName } from "../features/claude-code-session-state";
...
export function finalizeAgentConfig(
	...
	const agentResult = params.config.agent != null ? (params.config.agent as Record<string, unknown>) : {};

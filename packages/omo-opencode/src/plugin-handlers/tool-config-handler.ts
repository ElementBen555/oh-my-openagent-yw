...
const TASK_DENIED_SUBAGENT_KEYS = ["librarian", "explore", "oracle", "multimodal-looker", "metis", "momus"] as const;
...
export function applyToolConfig(params: {
	...
	const denyTodoTools = taskSystemEnabled ? { todowrite: "deny", todoread: "deny" } : {};

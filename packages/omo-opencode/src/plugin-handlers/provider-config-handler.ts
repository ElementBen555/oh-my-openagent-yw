...
export function applyProviderConfig(params: {
	...
	const providers = params.config.provider as Record<string, ProviderConfig> | undefined;
	...
	const visionCapableModelsCache =
		params.modelCacheState.visionCapableModelsCache ?? new Map<string, VisionCapableModel>();

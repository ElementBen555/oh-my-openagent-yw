...
type TransformHook = (input: Record<string, never>, output: { messages: TestMessage[] }) => Promise<void>;
...
async function runHandler(hooks: CreatedHooks, messages: TestMessage[]): Promise<void> {

...
export function routePromptSyncRetry(args: PromptSyncRetryArgs, directory: string): PromptSyncRetryArgs {
	return {
		...args,
		query: { directory },
	};
...
export function routeSessionMessages(args: SessionMessagesArgs, directory: string): SessionMessagesArgs {
	return {
		...args,
		query: { directory },
	};

...
function selectMostCommonClassification(entries: FsyncSkipEntry[]): FsyncSkipEntry["pathClassification"] {
...
export function formatFsyncSkipWarning(entries: FsyncSkipEntry[]): string {
	...
	const environmentLines =
		selectedClassification === "unknown" ? [] : [`Detected environment: ${selectedDescription}`];

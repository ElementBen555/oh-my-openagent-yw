...
export function createConnectedProvidersCacheStore(getCacheDir: () => string = dataPath.getOmoOpenCodeCacheDir) {
...
const defaultConnectedProvidersCacheStore = createConnectedProvidersCacheStore(() => dataPath.getOmoOpenCodeCacheDir());

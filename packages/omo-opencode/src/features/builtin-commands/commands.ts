...
import { CANCEL_RALPH_TEMPLATE, RALPH_LOOP_TEMPLATE, ULW_LOOP_TEMPLATE } from "./templates/ralph-loop";
import { REFACTOR_TEAM_MODE_ADDENDUM, REFACTOR_TEMPLATE } from "./templates/refactor";
import { REMOVE_AI_SLOPS_TEAM_MODE_ADDENDUM, REMOVE_AI_SLOPS_TEMPLATE } from "./templates/remove-ai-slops";

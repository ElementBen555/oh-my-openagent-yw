...
export function getRegisteredProcessCleanupSignalListener(signal: ProcessCleanupSignal): () => void {
...
export function getNewListener(signal: ProcessCleanupEvent, existingListeners: Function[]): () => void {

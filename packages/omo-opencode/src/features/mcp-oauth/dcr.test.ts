...
import { type ClientCredentials, type ClientRegistrationStorage, type DcrFetch, getOrRegisterClient } from "./dcr";

function createStorage(
	initial: ClientCredentials | null,
): ClientRegistrationStorage & { getLastKey: () => string | null; getLastSet: () => ClientCredentials | null } {
	let stored = initial;

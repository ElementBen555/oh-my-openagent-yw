import type { buildEnvelope } from "@oh-my-opencode/team-core/team-mailbox/poll";
...
export async function deliverLiveToRecipient(input: {
	...
	const { client, message, envelope, teamRunId, recipientName, recipientMember, reservation, config, directory } =
		input;

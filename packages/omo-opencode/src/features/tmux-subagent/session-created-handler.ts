...
import { type ExecuteActionsResult, executeActions } from "./action-executor";
...
export async function handleSessionCreated(deps: SessionCreatedHandlerDeps, event: SessionCreatedEvent): Promise<void> {

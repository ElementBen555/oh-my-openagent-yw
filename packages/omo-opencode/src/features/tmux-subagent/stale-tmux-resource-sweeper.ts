...
export async function sweepStaleTmuxResources(deps: StaleTmuxResourceSweepDeps): Promise<StaleTmuxResourceSweepReport> {
	const killedIsolatedSessions = deps.isolation === "session" ? await deps.sweepStaleOmoAgentSessions() : 0;

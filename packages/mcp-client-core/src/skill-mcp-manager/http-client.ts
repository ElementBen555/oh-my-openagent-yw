...
type HttpTransportFactory = (url: URL, options?: { requestInit?: RequestInit }) => McpTransport;
...
export function setHttpClientDependenciesForTesting(dependencies?: Partial<HttpClientDependencies>): void {

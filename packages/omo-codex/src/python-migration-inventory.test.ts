...
const requiredRetainedPythonFiles = ["packages/omo-codex/plugin/components/lsp/test/fixtures/broken.py"] as const;
...
const retainedPythonFiles = [...requiredRetainedPythonFiles, ...optionalGeneratedPythonFiles] as const;

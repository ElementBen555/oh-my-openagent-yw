import type { PostHogActivityCaptureState, PostHogActivityState } from "@oh-my-opencode/telemetry-core";
import { getDailyActiveCaptureState, getTelemetryActivityStateFilePath } from "@oh-my-opencode/telemetry-core";
